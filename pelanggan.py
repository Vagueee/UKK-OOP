...
def start_pelanggan(self):
    ...
    model.create_crud_button(self, frame=self.pelanggan, x=355, y=110, text="Tambah Data", command=tambah_pelanggan)
    model.create_crud_button(self, frame=self.pelanggan, x=480, y=110, text="Edit Data", command=edit_pelanggan)
    model.create_crud_button(self, frame=self.pelanggan, x=600, y=110, text="Delete Data", command=delete_pelanggan)
