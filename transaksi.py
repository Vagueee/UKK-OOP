...
def start_transaksi(self):
    ...
    model.create_crud_button(self, frame=self.transaksi, x=355, y=110, text="Tambah Data", command=tambah_transaksi)
    model.create_crud_button(self, frame=self.transaksi, x=480, y=110, text="Edit Data", command=edit_transaksi)
    model.create_crud_button(self, frame=self.transaksi, x=600, y=110, text="Delete Data", command=delete_transaksi)
